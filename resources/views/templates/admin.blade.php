    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                ...
                <span>Funzioni utente normale</span>
            </a>
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Custom Funzioni:</h6>
                    <a class="collapse-item" href="utilities-color.html">Albums Categories</a>
                    <a class="collapse-item" href="utilities-border.html">Albums</a>
                    <a class="collapse-item" href="utilities-animation.html">Pictures</a>
                </div>
            </div>
        </li>
